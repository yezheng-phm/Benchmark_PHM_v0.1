#--------------------------------------------------------
#--this file is used to adapt experiment data for CNN model.
#--------------------------------------------------------

import torch


class CNNDataAdapter:
...
#-----------------------------------------------------------------------------------------------
   ...
   #--adapt data for the CNN model.
    def _prepare_data(self, file_path):
        """Load and adapt the dataset for the CNN model."""
        ...
        #--reshape the tensors for CNN input
        #--shape: samples × channels × sequence_length
